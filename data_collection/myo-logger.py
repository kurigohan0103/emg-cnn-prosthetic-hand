...
if __name__ == '__main__':
    ...
    parser.add_argument('--emg_mode', type=int, default=EMGMode.RAW_FILTERED,
                        choices=[m.value for m in EMGMode],
                        help='Choose the EMG mode ({0})'.format(modes))
    parser.add_argument('-o', '--outdir', metavar='path', default='./data',
    ...
    m.subscribe(emg_mode=EMGMode.RAW_FILTERED)
